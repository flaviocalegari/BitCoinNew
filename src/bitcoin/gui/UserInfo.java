...
public class UserInfo extends javax.swing.JFrame {
    ...
    private MulticastPeer start() {
        ...
        SwingWorkerImpl worker;
        MulticastPeer conexao = null;
        conexao = new SwingWorkerImpl().conexao;
        // worker = new SwingWorkerImpl(); 
         
         //conexao = worker.onPostExecute();
        //worker.
        return conexao;                
    }
    ...
    public class SwingWorkerImpl extends SwingWorker<MulticastPeer, Void> {
        ...
        protected MulticastPeer doInBackground()
            ...
            this.conexao = new MulticastPeer(sessao);
            System.out.println("Conexao " + conexao);
            System.out.println("Socket " + conexao.socket);
            return this.conexao;
        }
